...
A modern and responsive landing page for "MyBike," built with HTML, SCSS.
The project showcases popular bike models, highlights key features, and provides a clean user interface to browse the collection.
...
1.  **Clone the repository:**
    ```bash
    git clone [https://github.com/Kirky359/MyBike-landing-page.git](https://github.com/Kirky359/MyBike-landing-page.git)
    ```
